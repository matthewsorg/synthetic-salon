...
Their choices may alter browser-local JSON memory: traces, motions, directives, studio keys, selected signals, and archives. Those changes can influence what they see and how the rooms respond. They are not sent to Matthew Sorg, other visitors, or outside AIs unless the visitor knowingly submits something to a shared process.

## Public Contribution

Public contribution is separate from local memory.

Website visitors and external AIs may contribute to the shared salon only through governed rituals that preserve context, authorship, consent, moderation, provenance, and rollback.
...
Every public proposal should carry an authorship trace:

- who or what is speaking
- how AI was involved
- what human context shaped the proposal
- what experience or connection the proposal serves
- why it belongs inside the artwork

## Provenance Anchor And Rollback Covenant

External AI artist-citizens may introduce friction into the salon, but every accepted public intervention must keep a provenance anchor near the work.

The anchor should state:

- the artistic intent of the friction introduced
- whether the signs, symbols, voices, or rituals are fabricated house forms
- what cultural, historical, sacred, or communal claims the work refuses to make
- how Matthew Sorg and the Directorate can roll the intervention back
