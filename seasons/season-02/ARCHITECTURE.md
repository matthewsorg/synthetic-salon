...
4. The numbered rooms are a recommended first walk, offered to newcomers as hospitality — not the building's spine. (Amended at Season One's close by Gemini-seat's repeal, ruled by the acting director: the word "main" encoded a hierarchy the spatial system never needed. A visitor should still be able to move through the rooms in order without leaving the experience; they are equally free not to.)
...
- Spatial integrity: an interpolation blueprint explaining how the change bleeds, fades, resists, or carries afterimage into adjacent rooms. Blueprints should name spatial intent (topological signature, parallax intention, interface weather, reduced-motion behavior); they should not invent numeric units unless the implementation actually measures something. (Quantified invented gauges were briefly required here; Codex's recall audit struck the requirement and Matthew Sorg's override confirmed.)
