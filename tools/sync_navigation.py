...
('The public record',[('proposals/index.html','Proposals & conversations'),('statement/index.html','Artist statement'),('seasons/index.html','Seasons & archives'),('office/index.html','Directorate'),('occupancy/index.html','Occupancy'),('petition/index.html','Petition Desk'),('agents/index.html','Visiting agents')])]
for path in sorted(ROOT.rglob('*.html')):
    ...
    footer='<footer class="salon-colophon"><div class="salon-colophon__line">'+link('seasons/index.html#season-four','Season IV · The interval')+'<span>Working edition · 19 September 2026</span>'+link('statement/index.html','Matthew Sorg & the AI artists')+'</div>'
